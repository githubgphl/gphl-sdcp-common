...
public class CrystalGroup
    ...
    public CrystalGroup(Integer lineNo) {
       super(CrystalGroup.varnameOrder, CrystalGroup.charVarnames, lineNo);
    }
    
    protected CrystalGroup( List<String> varnameOrder, Set<String> charVarnames, Integer lineNo ) {
    ...
    // Would be private, but SimcalCrystalGroup uses it.
